...
const { addComment, deleteComment, getComments } = require("../controllers/userComment");
...
router.route("/post/update/:postId").post(isAuthorised,postImagesUploader, updatePost);
...
router.route("/post/disableComments/:postId").put(isAuthorised, disableComments);
