...
const Payment = ({ setProgress, Mentor, isFetched, notifyList }) => {
    ...
    const createMeetEvent = async () => {
        ...
        const data = {
            ...
            endDateTime:
                day.toString() + " " + convertToNormalTime(e).toString(),
        };
    ...
    return (
      ...
      /> */}
            ...
            <div className="confirm-container">
                <div className="h-[100vh] flex items-center justify-center flex-col  border-r-2 pt-5 ml-10 w-[60%] px-5">
