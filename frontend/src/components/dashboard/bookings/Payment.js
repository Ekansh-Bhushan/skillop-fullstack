            ...
            <div className='confirm-container'>
                ...
                <div className='right-content'>
                    ...
                    <div className="qr-container">
                        <h3 style={{ color: "red", textAlign: "center", margin: "2vw" }}>Scan QR Code to pay</h3>
                        <div className="qr-code" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "1vw" }}>
                                ...
                                <input type="file" accept='image/*' name="payment-proof" id="payment-proof" onChange={
                                    (e) => {
