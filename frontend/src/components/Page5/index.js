...
function Auth5Component({ setProgress }) {
    ...
    const searchCollege = async (qrr) => {
        try {
            const { data } = await axios.get(
                `http://localhost:4000/api/college/info?college=${qrr}`,
                {
                    headers: {
    ...
    const handleOnChange = (e) => {
        ...
        document.querySelector(".college-search-results").style.display =
            "block";
            ...
            <div className="main-5">
                ...
                <div className="search-college">
                            ...
                            ? collegeSearchResults.map((college, idx) => {
                                  return (
                                      <div
                                          ...
                                          id="college-result"
                                          onClick={() =>
                                              handleCollegeSelection(college)
                                          }
                                      >
                    ...
                    <p id="note-search" style={{ marginTop: "15px" }}>
                        Note : If your college is not found in search, enter it
                        below manually
                    </p>
                </div>
                <form
