...
const Profile = ({ setProgress, Mentor, isFetched, notifyList }) => {
  ...
  useEffect(() => {
    fetchUserDetails();
  }, [handleDelExp, handleDelEdu, updateDom]);
      ...
      <div className="main-profile-page">
        ...
        <div className="profile-data">
          <div className="journey">
            ...
            <button
              className={`read-more-button ${isJourneyExpanded ? "expanded" : ""
                }`}
          ...
          <div className="journey">
            ...
            {isButtonClicked3 ? (
              ...
              <div
                className={`journey-content ${isFutureExpanded ? "expanded" : ""
                  }`}
              >
                <p className={`lorem-ipsum-dolor`}>
            ...
            <button
              className={`read-more-button ${isFutureExpanded ? "expanded" : ""
                }`}
                    ...
                    <div key={item._id} className="experience-content">
                      ...
                      >
                        <img
                          src={editIcon}
                          id="edit-text"
                          className={`add-icon ${isButtonClicked ? "active" : ""
                            }`}
                          onClick={(e) => {
