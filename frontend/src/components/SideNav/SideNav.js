        ...
        <>
            <ul className="side-nav-container">
                ...
                <li onClick={handleSlots}>
                    ...
                    {!Mentor && (
                        <img id="notify-lock" src="/lock1.png" alt="lock" />
                    )}
                </li>
                ...
                <li
                    id="setting"
                    style={{ position: "absolute", bottom: "0", gap: "15px" }}
                    className="settings-opt"
                    onMouseOver={displayxtra}
                >
                    ...
                    >
                        ...
                        <div
                            style={{ color: "#FF4141", padding: "5px" }}
                            onClick={logout}
                        >
                            Logout
                        </div>
