  ...
  const newsEvents = [
    {
      ...
      description: 'We crushed it with a killer Number Plate Detection System using YOLOv8, snagging an epic 17th place! 🚀🔥',
      date: '7th-8th September 2023, MNIT Jaipur'
    },
    {
      image: event2,
      headline: 'Intel GenAI Hackathon',
      description: '72hr long Hackathon! Using Intel AI Analytic Toolkit We developed Health Assistance and Tumor Detection Chatbot showcasing our Creativity and Hard work💪.',
    ...
    },
    {
      ...
      description: 'Skillop Society proudly presents the Cryptic Hunt on Machine Learning. Join us for an unforgettable adventure! 🚀🧠 #SkillopTeam',
      date: 'August 20 2024, Delhi Technological University'
    },
    {
      image: event4,
      headline: 'TechFest IITB',
      description: 'Secured an impressive 7th place in the competition! 🥳💼  Developed an AI agent designed to streamline the hiring process for companies. 🚀',
      date: '27th-29th December 2023, IIT Bombay'
    },
    {
      image: event5,
      headline: 'Vihaan007 Hackathon',
      description: "North India's largest student-led hackathon!!🚀 Made it to Top 100! showcasing innovation and determination as we tackled real-world challenges.",
    ...
    <div className="landing-page-container">
      ...
      <main className="landing-page-main">
        ...
        <div className="landing-page-boxes">
          ...
          <div className="landing-page-box news-events" onClick={handleNewsEventClick}>
        ...
        <section className="landing-page-content">
          <p>
            <span className="highlight">Welcome to SKILLOP Society, where innovation meets opportunity.</span>
            <span>
              Founded with a vision to empower students with cutting-edge skills in technology, SKILLOP Society is a vibrant community at the forefront of technological advancement.
              Through different workshops, mentorship programs, and competitive events, we cultivate a culture of learning, collaboration, and growth.
              Join us to unleash your potential, build meaningful connections, and shape the future of technology together.
            </span>
          </p>
        </section>
      </main>
      ...
      <div className="message-section" ref={messageBoxRef}>
        <div className="message-container">
          <div className="message-box">
            ...
            <p>
              Don't miss the amazing opportunities Skillop has to offer.<br></br>
      ...
      <section className="landing-page-content">
          <p>
            <span className="highlight">Dive into Skillop: More Than a Tech Society.</span>
            <span>
            Apart from Skillop being a Tech Society, We also present you a platfrom "SKILLOP" where Everyone is Mentor and Everyone is Mentee. 
            An educational platform buzzing with opportunities to learn, teach, and grow together.
            Here, the exchange of knowledge is endless and the features are designed to help you thrive. 
            Ready to explore? Join us now and be part of something extraordinary! 
            </span>
          </p>
        </section>
        <button className="get-started-btn" onClick={signupClicked}>
